...
-   Add alert dialog for edge case, where creating section template with empty target names crashes the application
-   Remove strict failure on existing metadata in imported data (plan template in this case)
